...
<label for="nog"><b>nob:</b></label> 
<input placeholder="Enter your password" type="number" name="no_of_gasbooked"/></br>
...
$get_b_id=$_SESSION['b_id'];
$query="select * from booking where b_id='$get_b_id'";
...
if($no_of_gasbooked =='')
{
echo "<script> alert('Please enter your no_of_gasbooked ')</script>";
exit();
}


$query="update booking set no_of_gasbooked='$no_of_gasbooked'  where b_id='$get_b_id'";
if(mysql_query($query))
{
$_SESSION['b_id']=$get_b_id;
echo "<script> alert('Updated Successfully') </script>";
echo "<br>";
echo " <a href='booking_view_details.php'>View result</a>"; 
} 

...
<body>
<div>
<form action="customer_search2.php" method="get"><br/><br/>
...
<input type="button" color="black"  value="FEEDBACK PAGE" onclick="fun1()"/>
<script> function fun1() { window.location="feedback.php"; } </script></br>

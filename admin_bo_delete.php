...
while ($row = mysql_fetch_array($sqldata)) {
    ...
    <tr bgcolor="<?php echo $class; ?>">
        ...
        <td class="button">
            <a href="bo_update.php?id=<?php echo $row['b_id']; ?>"><input type="button" name="update" value="Update"></a>
            <a href="bo_delete.php?id=<?php echo $row['b_id']; ?>"><input type="button" name="delete" value="Delete"></a>
        </td>
    </tr>
<?php $i++; } ?>
</table>
<a href="admin_bo_updatedelete.php"><h1><font color=pink fnt face='arial' size='6pt'>BACK</font></h1></a> 
</body>
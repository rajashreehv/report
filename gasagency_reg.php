...
<label  for="reg">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b>GASAGENCY&nbsp&nbspREGISTRATION&nbsp&nbspFORM</b></u></label><br><br>

<label for="phno"><b>User name:</b></label> 
<input placeholder="Enter your user name" type="text" name="username" pattern="[a-zA-Z ]*" required /></br>
...
<input placeholder="Enter your name" type="text" name="g_name" pattern="[a-zA-Z ]*" required  /></br>

<label for="address"><b>Address:</b></label> 
<input placeholder="Enter your address" type="text" name="g_address" pattern="[a-zA-Z0-9]*" required/></br>

<label for="phno"><b>Phone Number:</b></label> 
<input placeholder="Enter your phone number" type="text" name="g_phno" pattern="[789][0-9]{9}"/></br>



<label for="email"><b>Email:</b></label> 
<input placeholder="Enter your email" type="email" name="g_email" pattern="[a-zA-Z0-9]*[@][a-z]*[.][a-z]*" /></br>
...
<script> function fun1() { window.location="gasagency_login.php"; } </script></br>

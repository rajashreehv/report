...
<label  for="reg">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b>ADMIN&nbsp&nbspLOGIN&nbsp&nbspFORM</b></u></label><br><br>
...
$query=mysql_query("select * from admin where username='$username' and password='$password'") or die(mysql_error());
   ...
   $_SESSION['username']=$username;
	...
	header("location: admin_home.php.html?id=".$username);
   }
   else
   {

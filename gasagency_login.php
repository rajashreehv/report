...
<html>
<head>
<title> GAS AGENCY REGISTRATION FORM</title>
</head>
<style>
...
<label  for="reg">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u><b>GAS AGENCY&nbsp&nbspLOGIN&nbsp&nbspFORM</b></u></label><br><br>
...
<script> function fun1() { window.location="gasagency_reg.php"; } </script></br>



&nbsp&nbsp&nbsp&nbsp&nbsp&nbspClick here for &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
<input type="button" color="black"  value="START PAGE" onclick="fun1()"/>
<script> function fun1() { window.location="Startpage.html"; } </script></br>
...
$query=mysql_query("select * from gasagency where username='$username' and password='$password'") or die(mysql_error());
   ...
   $_SESSION['username']=$username;
	...
	header("location: gasagency_home.php.html?id=".$username);
   }
   else
   {
